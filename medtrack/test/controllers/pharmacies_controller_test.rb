...
class PharmaciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pharmacy" do
    assert_difference('Pharmacy.count') do
      post pharmacies_url, params: { pharmacy: { address: @pharmacy.address, comment: @pharmacy.comment, pharm_name: @pharmacy.pharm_name, phone_number: @pharmacy.phone_number } }, as: :json
    end
  ...
  test "should update pharmacy" do
    patch pharmacy_url(@pharmacy), params: { pharmacy: { address: @pharmacy.address, comment: @pharmacy.comment, pharm_name: @pharmacy.pharm_name, phone_number: @pharmacy.phone_number } }, as: :json
    assert_response 200
  end
